...
class SubmitMedicalRequestValidator implements RequestValidatorInterface
{
    ...
    public function validate(array $data, string $path = null): array
    {
        ...
        $v->rule(
            'required', ['certificateDate','patient', 'impression', 'doctor', 'purpose'
        ]);
        
        $v->rule('dateBefore', 'certificateDate', new \DateTime());
         $v->rule(
