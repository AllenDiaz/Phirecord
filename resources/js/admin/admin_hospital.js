...
window.addEventListener('DOMContentLoaded', function () {
    const viewHospitalModal = new Modal(document.getElementById('viewHospitalModal'))

    const table = new DataTable('#registeredHospitalTable', {
        serverSide: true,
    ...
    document.querySelector('#registeredHospitalTable').addEventListener('click', function (event) {
        ...
        if (viewBtn) {
            ...
            openViewHospitalModal(viewHospitalModal, viewId, viewImage, viewAdress)
        } else {
    ...
    function openViewHospitalModal(modal, id, image, address) {
