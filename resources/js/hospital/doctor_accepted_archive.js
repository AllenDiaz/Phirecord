...
window.addEventListener("DOMContentLoaded", function () {
  ...
  const table = new DataTable("#doctorAcceptedArchiveTable", {
    serverSide: true,
    ajax: "/hospital/doctor/accepted/archive/load",
    orderMulti: false,
    columns: [
      {
        sortable: false,
  ...
  document.querySelector("#doctorAcceptedArchiveTable").addEventListener("click", function (event) {
