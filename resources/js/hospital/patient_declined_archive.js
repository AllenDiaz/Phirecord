...
window.addEventListener("DOMContentLoaded", function () {
  ...
  const table = new DataTable("#patientDeclinedArchiveTable", {
    serverSide: true,
    ajax: "/hospital/patient/declined/archive/load",
    orderMulti: false,
    columns: [
      {
        sortable: false,
  ...
  document.querySelector("#patientDeclinedArchiveTable").addEventListener("click", function (event) {
